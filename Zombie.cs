...
public partial class Zombie : CharacterBody2D
{
	...
	public override void _Process(double delta)
	{
		if (IsActive){
			...
			AnimationPlayer Zombieanims = (AnimationPlayer)GetNode("AnimationPlayer");
			if (PlayerArea != null){
			...
			if (Z_LastPlayerPosition != null){
				...
				var zombiesprite = (Sprite2D)GetNode("Sprite2D");
				Zombieanims.Play("Move");
				if (MoveVector == new Vector2(1,0)){
					zombiesprite.Scale = new Vector2(1,1);
				}
	...
	public void Die(){
		...
		poofspawn.Position = GlobalPosition;
	}
	...
	private void _on_game_collision_body_entered(Node2D body)
	{
